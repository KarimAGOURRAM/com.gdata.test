...
public class mySQLdataBase {
	 ...
	 * 
	 * On Episode 5, I discussed that this method should not be private instead
	 * of public. This will make sure all sql/database relate code be place in
	 * the dao package. I am not doing this because I do not want to break the
	 * previous code... since this is just a tutorial project.
	 * 
	 * Pre-episode 6, updated this to a private scope, as it should be. That
	 * means, V1_inventory and V1_status methods needs to be updated.
	 * 
